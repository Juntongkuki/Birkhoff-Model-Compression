...
# from EdgeSAM.edge_sam.utils.transforms import ResizeLongestSide
# from EdgeSAM.edge_sam.utils.common import xywh2xyxy
from .utils.transforms import ResizeLongestSide
from .utils.common import xywh2xyxy
import copy
...
class COCODataset(torch.utils.data.Dataset):
    ...
    def prepare_data(self):
        ...
        if self.annotation == 'coco':
            anno_path = f'{self.data_root}/json_files/instances_{self.split}2017.json'
    ...
    def __getitem__(self, idx):
        ...
        img_path = f"{self.data_root}/val2017/{file_name}"
