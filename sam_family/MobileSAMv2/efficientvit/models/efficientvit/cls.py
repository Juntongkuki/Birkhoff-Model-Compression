...
from sam_family.MobileSAMv2.efficientvit.models.efficientvit.backbone import EfficientViTBackbone, EfficientViTLargeBackbone
from sam_family.MobileSAMv2.efficientvit.models.nn import ConvLayer, LinearLayer, OpSequential
from sam_family.MobileSAMv2.efficientvit.models.utils import build_kwargs_from_config
...
def efficientvit_cls_b0(**kwargs) -> EfficientViTCls:
    from sam_family.MobileSAMv2.efficientvit.models.efficientvit.backbone import efficientvit_backbone_b0
...
def efficientvit_cls_b1(**kwargs) -> EfficientViTCls:
    from sam_family.MobileSAMv2.efficientvit.models.efficientvit.backbone import efficientvit_backbone_b1
...
def efficientvit_cls_b2(**kwargs) -> EfficientViTCls:
    from sam_family.MobileSAMv2.efficientvit.models.efficientvit.backbone import efficientvit_backbone_b2
...
def efficientvit_cls_b3(**kwargs) -> EfficientViTCls:
    from sam_family.MobileSAMv2.efficientvit.models.efficientvit.backbone import efficientvit_backbone_b3
...
def efficientvit_cls_l1(**kwargs) -> EfficientViTCls:
    from sam_family.MobileSAMv2.efficientvit.models.efficientvit.backbone import efficientvit_backbone_l1
...
def efficientvit_cls_l2(**kwargs) -> EfficientViTCls:
    from sam_family.MobileSAMv2.efficientvit.models.efficientvit.backbone import efficientvit_backbone_l2
...
def efficientvit_cls_l3(**kwargs) -> EfficientViTCls:
    from sam_family.MobileSAMv2.efficientvit.models.efficientvit.backbone import efficientvit_backbone_l3
