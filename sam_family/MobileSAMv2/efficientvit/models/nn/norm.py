...
def reset_bn(
    ...
    from sam_family.MobileSAMv2.efficientvit.apps.utils import AverageMeter, sync_tensor
    from sam_family.MobileSAMv2.efficientvit.models.utils import get_device, list_join
