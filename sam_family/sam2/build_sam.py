...
def build_sam2_hiera_tiny(checkpoint=None, device='cpu'):
    return build_sam2(
        'sam2_hiera_t.yaml',
...
def build_sam2_hiera_small(checkpoint=None, device='cpu'):
    return build_sam2(
        'sam2_hiera_s.yaml',
        ckpt_path=checkpoint,
        device=device,
...
def build_sam2_hiera_base_plus(checkpoint=None, device='cpu'):
    return build_sam2(
        'sam2_hiera_b+.yaml',
        ckpt_path=checkpoint,
        device=device,
...
def build_sam2_hiera_large(checkpoint=None, device='cpu'):
    return build_sam2(
        'sam2_hiera_l.yaml',
        ckpt_path=checkpoint,
        device=device,
